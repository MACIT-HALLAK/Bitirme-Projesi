...
const EmailConfirm = () => {
  ...
  async function submit(event) {
    ...
    if (
      ...
      let res = await axios.post(
        'https://deneme.librarygop.com/public/index.php/api/register',
        {
          name: cookiesN.name,
  ...
  return (
    <div className="EmailVerify-parent">
      <div className="EmailVerify-icons">
        <FaEnvelopeOpenText size={48} />
      </div>
      <h2 className="EmailVerify-h2">Lütfen e-postanızı kontrol ediniz...</h2>
      <h5 className="EmailVerify-h5">
        Beş haneli kodu {cookiesE.email1} adresine gönderdik. İşlemi tamamlamak
        için lütfen kodu giriniz.
      </h5>
